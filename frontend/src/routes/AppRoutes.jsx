...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "/expense/daily-expenses", element: <DailyExpenses /> },
      { path: "/expense/all-expenses", element: <AllExpenses /> },
      { path: "/expense/weekly-expenses", element: <WeeklyExpenses /> },
      { path: "/expense/monthly-expenses", element: <MonthlyExpenses /> },
      { path: "/expense/yearly-expenses", element: <YearlyExpenses /> },
